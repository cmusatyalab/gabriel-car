...
public class NetworkProtocol {
    ...
    public static final int NETWORK_RET_LEGEND = 11;
    public static final int NETWORK_RET_VIZ_OBJECT_IMAGE = 12;
    ...
    public static final String SERVER_CONTROL_FOCUS = "focus";
